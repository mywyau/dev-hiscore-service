...
http -f POST http://localhost:8080/dev-irl-client-payment-service/upload file@./src/main/scala/controllers/UploadController.scala
...
http POST http://localhost:8080/dev-irl-client-payment-service/s3/presign-download key="uploads/ed677064-ac83-4bf5-9885-e834df6c80bc-UploadController.scala"
http POST http://localhost:8080/dev-irl-client-payment-service/s3/presign-download key="uploads/ed677064-ac83-4bf5-9885-e834df6c80bc-UploadController.scala"
http -f POST http://localhost:8080/dev-irl-client-payment-service/upload file@./src/main/scala/controllers/UploadController.scala
```
...
```
http POST http://localhost:8080/dev-irl-client-payment-service/s3/presign-download key=uploads/b508ce06-258e-4d0b-b314-0671cbd6c982-DevQuestBackendAuthController.test.ts
```
