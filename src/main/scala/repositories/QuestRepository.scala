...
//   def findAllByUserId(clientId: String): F[List[QuestData]]

//   def findByQuestId(questId: String): F[Option[QuestData]]

//   def findNotEstimatedQuests(): F[ValidatedNel[DatabaseErrors, ReadSuccess[List[QuestData]]]]
...
//   def streamAll(limit: Int, offset: Int): Stream[F, QuestData]

//   def streamByQuestStatus(clientId: String, questStatus: QuestStatus, limit: Int, offset: Int): Stream[F, QuestData]

//   def streamByQuestStatusDev(devId: String, questStatus: QuestStatus, limit: Int, offset: Int): Stream[F, QuestData]

//   def streamByUserId(clientId: String, limit: Int, offset: Int): Stream[F, QuestData]

//   def update(questId: String, request: UpdateQuestData): F[ValidatedNel[DatabaseErrors, DatabaseSuccess]]
...
//   override def streamByQuestStatus(clientId: String, questStatus: QuestStatus, limit: Int, offset: Int): Stream[F, QuestData] = {
//     val queryStream: Stream[F, QuestData] =
//       sql"""
...
//   override def streamByQuestStatusDev(devId: String, questStatus: QuestStatus, limit: Int, offset: Int): Stream[F, QuestData] = {
//     val queryStream: Stream[F, QuestData] =
//       sql"""
//         SELECT quest_id, client_id, dev_id, rank, title, description, acceptance_criteria, status, tags, estimated
//         FROM quests
...
//   override def streamByUserId(clientId: String, limit: Int, offset: Int): Stream[F, QuestData] = {
//     val queryStream: Stream[F, QuestData] =
//       sql"""
//         SELECT quest_id, client_id, dev_id, rank, title, description, acceptance_criteria, status, tags, estimated
//         FROM quests
...
//   override def streamAll(limit: Int, offset: Int): Stream[F, QuestData] = {
//     val queryStream: Stream[F, QuestData] =
//       sql"""
//             SELECT quest_id, client_id, dev_id, rank, title, description, acceptance_criteria, status, tags, estimated
//         FROM quests
...
//   override def findAllByUserId(clientId: String): F[List[QuestData]] = {
//     val findQuery: F[List[QuestData]] =
//       sql"""
//          SELECT 
//            quest_id, client_id, dev_id, rank, title, description, acceptance_criteria, status, tags, estimated
//          FROM quests
//          WHERE client_id = $clientId
//        """.query[QuestData].to[List].transact(transactor)

//     findQuery
//   }

//   override def findByQuestId(questId: String): F[Option[QuestData]] = {
//     val findQuery: F[Option[QuestData]] =
//       sql"""
//          SELECT 
//            quest_id, client_id, dev_id, rank, title, description, acceptance_criteria, status, tags, estimated
//          FROM quests
//          WHERE quest_id = $questId
//        """.query[QuestData].option.transact(transactor)
...
//   override def update(quest_id: String, request: UpdateQuestData): F[ValidatedNel[DatabaseErrors, DatabaseSuccess]] =
//     sql"""
//       UPDATE quests
//       SET
//           title = ${request.title},
...
//   override def findNotEstimatedQuests(): F[ValidatedNel[DatabaseErrors, ReadSuccess[List[QuestData]]]] =
//     sql"""
//       SELECT 
//          quest_id, client_id, dev_id, rank, title, description, acceptance_criteria, status, tags, estimated
//       FROM quests
...
//           ReadSuccess[List[QuestData]](retrievedRows).validNel
//         case Left(ex: java.sql.SQLException) if ex.getSQLState == "23503" =>
//           ForeignKeyViolationError.invalidNel
//         case Left(ex: java.sql.SQLException) if ex.getSQLState == "08001" =>
//           DatabaseConnectionError.invalidNel
